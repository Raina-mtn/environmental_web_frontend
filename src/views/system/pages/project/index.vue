  ...
  <div class="project-setting">
    <div class="project-setting__contain">
      <div class="contain-left">
        <setting-nav :nav-list="[{id: 1, name: '运维项目列表'}]" />
      </div>
      <div class="contain-right">
        ...
        <div class="px-20px bg-white" style="height: calc(100% - 80px);">
          <div class="flex items-center flex-row w-full mb-16px justify-between">
            ...
            <div class="relative">
              <el-button type="primary" size="mini" icon="el-icon-plus" @click="$refs.addProject.openDialog()">
                新增
              </el-button>
    ...
    <AddProject ref="addProject" @getList="refresh" />
  </div>
</template>
...
import { list, deleted } from '@/api/interface/system-project'
