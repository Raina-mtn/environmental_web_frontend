<template>
  ...
  >
    <div class="container h-65vh overflow-auto pr-16px">
      <div>
        <el-descriptions class="margin-top" title="β射线法仪器质控工作记录表" :column="2" border>
          <el-descriptions-item label="子站名称">
          ...
          <el-descriptions-item label="出厂编号" :span="2">
            {{ formData.gasFull || '' }}
          </el-descriptions-item>
        </el-descriptions>
        <el-descriptions class="margin-top" :column="1" border>
          <el-descriptions-item label="环境条件">
            <span>温度（℃）：</span>
            <span class="mr-48px ml-48px">湿度（%）：</span>
            <span>其它：</span>
          </el-descriptions-item>
        </el-descriptions>
