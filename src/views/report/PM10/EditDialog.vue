      ...
      <div>
        ...
        <el-descriptions class="margin-top" :column="1" border>
          <el-descriptions-item label="滤带使用情况">
            <!-- <span v-if="!editStatus || editKey !== 'dataName'">{{ formData.dataName ? `${formData.dataName}(${formData.dataCode})` : '海创园科技站' }}</span> -->
            <span v-if="!editStatus || editKey !== 'dataName'">{{ formData.dataName1 }}</span>
            <el-input v-if="editKey === 'dataName1' && editStatus" v-model="formData.dataName1" size="small" maxlength="20" style="width: 80%;" />
