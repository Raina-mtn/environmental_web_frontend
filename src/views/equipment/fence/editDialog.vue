<template>
  <el-dialog width="45%" :visible="isShow" :title="isEdit?'编辑电子围栏':'新增电子围栏'" top="30px" :destroy-on-close="true" @close="closeDialog()">
...
import { create,update } from '@/api/interface/fence'
export default {
  components:{
    WForm,
    ImageUpload,
