<template>
  <el-dialog width="45%" :visible="isShow" :title="isEdit?'编辑动环设备':'新增动环设备'" top="30px" :destroy-on-close="true" @close="closeDialog()">
...
import { create,update } from '@/api/interface/rotating'
export default {
  components:{
    WForm,
    ImageUpload,
