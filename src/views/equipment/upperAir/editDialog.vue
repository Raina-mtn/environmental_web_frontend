<template>
  <el-dialog width="45%" :visible="isShow" :title="isEdit?'编辑高空瞭望':'新增高空瞭望'" top="30px" :destroy-on-close="true" @close="closeDialog()">
...
import { create,update } from '@/api/interface/upperAir'
export default {
  components:{
    WForm,
    ImageUpload,
