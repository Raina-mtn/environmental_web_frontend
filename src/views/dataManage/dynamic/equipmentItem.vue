  ...
  <div class="bg-[#F6F6F6] w-full h-full px-16px py-21px text-14px">
    ...
    <el-form v-if="type==='airCondition'" ref="form" :model="formData" label-width="80px">
      ...
      <el-form-item label="模式设置" size="small">
        <el-radio-group v-model="formData.switchMode" :disabled="!formData.openFlag" @change="setAirCondition">
      ...
      <el-form-item label="温度设置">
        <el-select v-model="formData.setTemp" placeholder="请选择" size="small" class="!w-1/2" :disabled="!formData.openFlag" @change="setAirCondition">
          <el-option
